...
<head>
    ...
    <title>Lumini - Moda Feminina</title>
    ...
    <div class="container header-container">
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?= base_url('feminino') ?>" class="active">Feminino</a></li>
...
<section class="hero hero-small">
    <div class="container hero-content">
        <h1>Moda Feminina Lumini</h1>
        <p>Elegância e conforto para todos os momentos 🌸</p>
    </div>
</section>

<section class="container">
    <h2 class="section-title">Destaques Femininos</h2>
    <div class="products">
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1520975918318-3c8cbbfb005e?auto=format&fit=crop&w=700&q=80" alt="Vestido Floral">
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1578685706557-3b74691eae09?auto=format&fit=crop&w=700&q=80" alt="Blusa Social">
            <div class="product-info">
                <h3>Blusa Social</h3>
                <p class="product-price">R$ 89,90</p>
                <button class="btn" onclick="adicionarAoCarrinho(2)">Adicionar ao Carrinho</button>
            </div>
        </div>
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?auto=format&fit=crop&w=700&q=80" alt="Saia Midi">
            <div class="product-info">
                <h3>Saia Midi</h3>
                <p class="product-price">R$ 139,90</p>
                <button class="btn" onclick="adicionarAoCarrinho(3)">Adicionar ao Carrinho</button>
            </div>
        </div>
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1574450572059-6e7c8de9b37a?auto=format&fit=crop&w=700&q=80" alt="Jaqueta Feminina">
            <div class="product-info">
                <h3>Jaqueta Feminina</h3>
                <p class="product-price">R$ 249,90</p>
                <button class="btn" onclick="adicionarAoCarrinho(4)">Adicionar ao Carrinho</button>
            </div>
        </div>
    </div>
</section>
...
<section class="newsletter">
    <div class="container">
        <h2>Receba Nossas Novidades Femininas</h2>
