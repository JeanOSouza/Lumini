    ...
    <div class="container header-container">
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?= base_url('feminina') ?>">Feminino</a></li>
                ...
                <li><a href="<?= base_url('ofertas') ?>" class="active">Ofertas</a></li>
            </ul>
        </nav>
...
<section class="hero hero-small">
    <div class="container hero-content">
        ...
        <p>Descontos de até 50% em toda a loja 🛍</p>
    </div>
</section>
    ...
    <div class="products">
        <div class="product-card">
            ...
            <div class="product-info">
                ...
                <p class="product-price"><s>R$ 159,90</s> R$ 99,90</p>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <h3>Jaqueta Jeans</h3>
                <p class="product-price"><s>R$ 199,90</s> R$ 139,90</p>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <h3>Blusa Social</h3>
                <p class="product-price"><s>R$ 89,90</s> R$ 59,90</p>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                ...
                <p class="product-price"><s>R$ 119,90</s> R$ 79,90</p>
...
<section class="newsletter">
    <div class="container">
        <h2>Assine e receba cupons de desconto</h2>
